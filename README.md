...
Trigger `wp-cron.php` for one WordPress site reliably from Cloudflare's network, replacing WordPress's built-in scheduler. Switch between main and multi-site branch for the version that suits you.
